 ...
 * @author renmess
 */
@WebServlet(name = "BookServlet", urlPatterns = {"/libros"})
public class BookServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(termino != null && !termino.trim().isEmpty()){
            libros = bookDAO.buscarLibros(criterio, termino);
        } else{
            libros = bookDAO.buscarLibros("todos", "");
        }
        
        request.setAttribute("bookList", libros);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Book libro_nuevo = new Book(titulo, autor, precio);
        bookDAO.anadirLibro(libro_nuevo);
